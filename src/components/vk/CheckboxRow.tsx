...
import { useCallback, useRef } from "@external/preact/hooks";
import { h } from "@external/preact";
import { iconCheckbox, iconCheckboxChecked } from "@/assets";
...
const S = toStyleCombiner(
  {
    ...
    checkbox: {
      ...
      "& input[type=checkbox]+label::before": {
        ...
        content: "''",
        float: "left",
        background: `${iconCheckbox.url} no-repeat 0`,
        margin: "0 7px 0 0",
        width: "15px",
        height: "15px",
      ...
      "& input[type=checkbox]:checked+label:before": {
        backgroundImage: iconCheckboxChecked.url,
      },
