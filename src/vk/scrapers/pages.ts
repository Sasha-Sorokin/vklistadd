...
export function getIcon(): string | null {
  ...
  const coverAvatar = elem<HTMLImageElement>(".page_cover_image img.post_img");
  ...
  const pageAvatar = elem<HTMLImageElement>(".page_avatar img.page_avatar_img");
...
const notificationsTogglers = new WeakMap<Context, OptionalToggler>();
...
export function getNotificationsToggler(): NotificationsTogglerHook | null {
  ...
  let toggler = notificationsTogglers.get(context);
  ...
  notificationsTogglers.set(context, toggler);
