...
declare global {
  ...
  namespace VK {
    ...
    abstract class MessageBox {
       ...
       */
      public abstract setOptions(options: Partial<IBoxOptions>): MessageBox;
    ...
    /**
     * Представляет собой возможные направления подсказки
     */
    type TooltipDirection = "auto" | "up" | "right" | "down" | "left";
