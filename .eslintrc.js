const config = {
  ...
  rules: {
    ...
    "@typescript-eslint/no-restricted-imports": [
      "error",
      {
        ...
        paths: [
          // All modules that are imported in a separate pack.
          {
            name: "preact",
            message: "Use getPreact() instead.",
            allowTypeImports: true,
          },
          {
            name: "preact/hooks",
            message: "Use getPreactHooks() instead.",
            allowTypeImports: true,
          },
          {
            name: "simplestyle-js",
            message: "Use utils/faschion instead.",
            allowTypeImports: true,
          },
          {
            name: "debounce",
            message: "Use getDebounce() instead.",
            allowTypeImports: true,
          },
          {
            name: "uid",
            message: "Use getUid() instead.",
            allowTypeImports: true,
          },
        ],
      },
  ...
  plugins: ["jsdoc", "@typescript-eslint", "userscript"],
  settings: {
    jsdoc: {
      mode: "closure",
    },
